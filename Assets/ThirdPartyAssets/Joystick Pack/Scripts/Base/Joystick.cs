...
public class Joystick : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    ...
    public event Action<Vector2> OnPointerHoldEvent;
    ...
    public virtual void OnPointerDown(PointerEventData eventData)
    {
        ...
        StartCoroutine(InvokeHoldEvent());
    }

    public virtual IEnumerator InvokeHoldEvent()
    {
        while (isPointerHeld)
        {
            OnPointerHoldEvent?.Invoke(input);
            yield return null;
        }
